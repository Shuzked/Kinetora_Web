...
const Services = () => {
  ...
  return /* @__PURE__ */ jsx(ClientOnly, { children: /* @__PURE__ */ jsxs("section", { id: "servicios", className: "py-20 sm:py-24 lg:py-32 bg-[#0D0D0D] relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10 text-center md:text-left", children: [
      /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mb-12 sm:mb-16 lg:mb-24 mx-auto md:mx-0", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-[#F5F5F5]/70 text-sm sm:text-base leading-relaxed px-4 md:px-0", children: copy.sub })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 sm:gap-6", children: copy.cards.map((card, i) => {
          ...
          motion.article,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: "pointer-events-none absolute inset-0", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#0D0D0D] via-transparent to-transparent opacity-60" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "relative z-10 mb-8", children: /* @__PURE__ */ jsx("div", { className: "relative inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white/5 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.10)] transition-all duration-300 group-hover:bg-[#B454FF]/10 group-hover:border-[#B454FF]/30", children: /* @__PURE__ */ jsx(Icon, { className: "w-6 h-6 text-[#B454FF] transition-transform duration-300 group-hover:rotate-3" }) }) }),
              /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
                /* @__PURE__ */ jsx("h3", { className: `${isLarge ? "text-3xl md:text-4xl" : "text-xl md:text-2xl"} font-black text-[#F5F5F5] mb-4 uppercase tracking-tighter`, children: card.title }),
                /* @__PURE__ */ jsx("p", { className: `text-[#F5F5F5]/70 font-medium ${isLarge ? "text-lg md:text-xl" : "text-sm md:text-base"} leading-relaxed max-w-sm`, children: card.desc })
              ] })
            ]
          },
          i
