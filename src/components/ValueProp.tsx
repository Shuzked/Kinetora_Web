    ...
    <section className="py-32 bg-[#0D0D0D] relative">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-black text-[#F5F5F5] mb-6 tracking-tighter uppercase">
            EL FIN DE LA <br />
            <span className="text-[#2A2A2A]">FRICCIÓN CREATIVA.</span>
          </h2>
          <p className="text-[#2A2A2A] font-bold uppercase tracking-widest text-xs">¿Por qué las startups eligen Kinetora?</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-[#111111]/50 border border-[#2A2A2A] rounded-[3rem] p-10 md:p-12 relative group grayscale hover:grayscale-0 transition-all duration-700"
          >
            <div className="flex items-center gap-3 mb-10">
              <div className="w-10 h-10 rounded-full bg-red-500/10 flex items-center justify-center">
                <AlertCircle className="w-5 h-5 text-red-900/40" />
              </div>
              <h3 className="text-lg font-bold text-[#2A2A2A] uppercase tracking-widest">Agencias Tradicionales</h3>
            </div>
            ...
            <ul className="space-y-8">
              {[
                ...
                <li key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-[#2A2A2A] font-bold text-sm uppercase tracking-tight mb-1">{item.t}</div>
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, x: 30 }}
            viewport={{ once: true }}
            className="bg-gradient-to-b from-[#111111] to-[#0D0D0D] border border-[#B454FF]/30 rounded-[3rem] p-10 md:p-12 relative overflow-hidden shadow-[0_0_50px_rgba(180,84,255,0.05)]"
          >
            ...
            <ul className="space-y-8 relative z-10">
              {[
                ...
                <li key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-[#F5F5F5] font-bold text-sm uppercase tracking-tight mb-1">{item.t}</div>
            ...
            <div className="mt-12 pt-8 border-t border-[#2A2A2A]">
              <div className="text-[10px] font-black text-[#B454FF] uppercase tracking-[0.3em]">Recomendado para Series A/B</div>
            </div>
          </motion.div>
        </div>
      </div>
