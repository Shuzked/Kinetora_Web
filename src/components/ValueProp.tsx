  ...
  return (
    <section className="kin-section relative overflow-hidden sm:overflow-visible kin-no-overflow">
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#0D0D0D] via-[#0D0D0D]/70 to-transparent" />
        <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#0D0D0D] via-[#0D0D0D]/70 to-transparent" />
      </div>
