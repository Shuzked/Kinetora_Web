...
const BackgroundParallax: React.FC = () => {
  ...
  // Optimizacion masiva para móvil: Si es móvil, desactivamos el tracking de scroll JS por completo
  // Los elementos quedan fijos con opacidad baja, ahorrando un 100% del procesamiento de scroll
