  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <div className="absolute bottom-0 w-full max-w-6xl left-1/2 -translate-x-1/2 px-4 pb-6 pt-10 z-20 bg-gradient-to-t from-black/80 to-transparent">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              >
                <div className="flex items-baseline whitespace-nowrap text-3xl md:text-4xl font-extrabold tracking-tight text-[#F5F5F5]">
