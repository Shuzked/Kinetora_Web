...
> = {
  ...
  "cybertitans-clash-impacto-brutal-y-evolucion-web3": {
    esTextHtml: [
      ...
      "<p>Nuestra agencia construyó toda esta plataforma gráfica. A continuación, detallamos cada pieza entregada a la desarrolladora. <a href=\"https://cybertitans.io\" target=\"_blank\" rel=\"noopener noreferrer\">Visita la web oficial de CyberTitans</a> para descubrir el juego completo.</p>",
      "<h2>Estrategia de Marketing Web3: Activos Creados</h2>",
