...
> = {
  "elixir-games": {
    ...
    esMediaHtml: [
      ...
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/elix-character.png" alt="ELIXIR GAMES — Diseño de Personajes y Activos 3D de $ELIX" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/token-burn.png" alt="ELIXIR GAMES — Campaña de Quemado de Tokens $ELIX" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/season-pass.png" alt="ELIXIR GAMES — Recompensas de Pase de Temporada y Clasificaciones" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/lottery.png" alt="ELIXIR GAMES — Sorteo Comunitario y Evento de Cierre" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Diseño de Roll-ups y Cartelería para Eventos Globales" loading="lazy" /></figure>',
    ...
    enMediaHtml: [
      ...
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/elix-character.png" alt="ELIXIR GAMES — $ELIX Character and 3D Assets" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/token-burn.png" alt="ELIXIR GAMES — $ELIX Token Burn Campaign and Supply Reduction" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/season-pass.png" alt="ELIXIR GAMES — Season Pass Rewards and Leaderboards" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/lottery.png" alt="ELIXIR GAMES — Community Lottery and Closing Event" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Roll-up and Signage Design for Global Events" loading="lazy" /></figure>',
