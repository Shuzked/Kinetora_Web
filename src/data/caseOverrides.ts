...
> = {
  "elixir-games": {
    ...
    esMediaHtml: [
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/ux-reimagined.webp" alt="ELIXIR GAMES — Interfaz de Usuario y Experiencia de Aplicación" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/kbw-event.webp" alt="ELIXIR GAMES — Evento Korean Blockchain Week y Networking" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/hoodie-design.webp" alt="ELIXIR GAMES — Diseño de Merchandising y Ropa Oficial" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/elix-character.webp" alt="ELIXIR GAMES — Diseño de Personajes y Activos 3D de $ELIX" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/token-burn.webp" alt="ELIXIR GAMES — Campaña de Quemado de Tokens $ELIX" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/season-pass.webp" alt="ELIXIR GAMES — Recompensas de Pase de Temporada y Clasificaciones" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/lottery.webp" alt="ELIXIR GAMES — Sorteo Comunitario y Evento de Cierre" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.webp" alt="ELIXIR GAMES — Diseño de Roll-ups y Cartelería para Eventos Globales" loading="lazy" /></figure>',
    ...
    enMediaHtml: [
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/ux-reimagined.webp" alt="ELIXIR GAMES — User Interface and Application Experience" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/kbw-event.webp" alt="ELIXIR GAMES — Korean Blockchain Week Event & Networking" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/hoodie-design.webp" alt="ELIXIR GAMES — Official Merchandise and Apparel Design" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/elix-character.webp" alt="ELIXIR GAMES — $ELIX Character and 3D Assets" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/token-burn.webp" alt="ELIXIR GAMES — $ELIX Token Burn Campaign and Supply Reduction" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/season-pass.webp" alt="ELIXIR GAMES — Season Pass Rewards and Leaderboards" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/lottery.webp" alt="ELIXIR GAMES — Community Lottery and Closing Event" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.webp" alt="ELIXIR GAMES — Roll-up and Signage Design for Global Events" loading="lazy" /></figure>',
