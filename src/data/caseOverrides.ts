...
> = {
  "elixir-games": {
    ...
    esMediaHtml: [
      ...
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Launcher Oficial y Títulos Destacados" loading="lazy" /></figure>',
    ...
    enMediaHtml: [
      ...
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Official Game Launcher and Featured Titles" loading="lazy" /></figure>',
