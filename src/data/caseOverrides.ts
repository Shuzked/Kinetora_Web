...
> = {
  "elixir-games": {
    ...
    esMediaHtml: [
      ...
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/ux-reimagined.png" alt="ELIXIR GAMES — Reimagined UX" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/kbw-event.png" alt="ELIXIR GAMES — Korean Blockchain Week Event" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/hoodie-design.png" alt="ELIXIR GAMES — Hoodie Design" loading="lazy" /></figure>',
      '<figure class="wp-block-image"><img src="/assets/cases/elixir-games/elix-character.png" alt="ELIXIR GAMES — $ELIX Character" loading="lazy" /></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/yd9LRPZ7EcQ" title="Elixir Video 1" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/CVZGqn06Lzs" title="Elixir Video 2" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/fbNkAekm8e0" title="Elixir Video 3" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/hZ-Z8dtvshE" title="Elixir Video 4" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/6NhEtTPYJkI" title="Elixir Video 5" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/LF61aJLSfkQ" title="Elixir Video 6" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/-zh8JhYhMVQ" title="Elixir Video 7" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/ee5oTpbSYnY" title="Elixir Video 8" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/K_kUS2zPV_U" title="Elixir Video 9" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/FoUMzboMMko" title="Elixir Video 10" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/sYZaBaDl5ts" title="Elixir Video 11" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/L1XyY1ldGkA" title="Elixir Video 12" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
      '<figure class="wp-block-embed"><iframe class="wp-embed" src="https://www.youtube.com/embed/1QUsy5eJd5g" title="Elixir Video 13" loading="lazy" frameborder="0" allowfullscreen></iframe></figure>',
    ].join(""),
    enTextHtml: [
