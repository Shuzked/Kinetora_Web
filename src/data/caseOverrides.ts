...
> = {
  ...
  "cybertitans-clash-impacto-brutal-y-evolucion-web3": {
    esTextHtml: [
      "<p>Actualizar un videojuego exige mucha fuerza visual. Presentar un nuevo modo de juego es un gran reto. Esto requiere un potente Marketing Web3. LitLab Games confió en nuestra agencia. Nos pidieron lanzar su nueva gran actualización. El modo \"Clash\" venía para cambiar la jugabilidad por completo.</p>",
      "<p>Nuestro objetivo principal era muy claro. Queríamos generar muchísima expectación antes del lanzamiento. Debíamos mantener el interés vivo en las redes sociales.</p>",
      "<p>Tomamos el control creativo de todo el proyecto. Diseñamos un entorno gráfico muy agresivo y tecnológico. Entregamos la plataforma web y vídeos de altísima calidad. El impacto fue totalmente masivo. Logramos superar la barrera de 1,5 millones de visualizaciones orgánicas. La actualización disparó la retención de usuarios.</p>",
      "<p>Nuestra agencia de marketing digital construyó toda esta plataforma. A continuación, detallamos cada pieza entregada.</p>",
      "<h2>Estrategia de Marketing Web3: Activos Creados</h2>",
      "<p>Rompimos las reglas clásicas del diseño digital. Creamos un paquete visual muy dinámico y atractivo. Nos basamos en tres grandes entregables clave:</p>",
      "<h3>1. Landing Page y Entorno Web Interactivo</h3>",
      "<p>Desarrollamos una página de aterrizaje totalmente espectacular. La web integra vídeo para mostrar toda la acción inmersiva. Destacamos el nuevo logo con su gran icono de fuego. Usamos colores naranja y amarillo muy vibrantes. El fondo tiene tonos morados y azules muy oscuros.</p>",
      "<p>Resaltamos los textos clave del nuevo formato. Anunciamos las partidas rápidas de solo tres jugadores (3 Players Match). Explicamos el gran sistema de multiplicadores de premios (Multipliers). La web cargó rápido y guio al usuario a jugar. Fue la base principal de nuestro Marketing Web3.</p>",
      "<h3>2. Vídeos, Motion e Imágenes (RRSS)</h3>",
      "<p>Las redes sociales necesitan mucho dinamismo diario. Entregamos un paquete visual gigante para Twitter, TikTok y Discord.</p>",
      "<p>Diseñamos banners estáticos con mucha fuerza visual. Creamos animaciones rápidas para enseñar los nuevos multiplicadores. Todo este gran material gráfico mantuvo a la comunidad alerta. Los usuarios no dejaron de interactuar durante toda la campaña.</p>",
      "<h3>3. Vídeo Manifiesto de Actualización (Edición y VFX)</h3>",
      "<p>El anuncio oficial debía romper internet de inmediato. Por ello, editamos un tráiler espectacular y lleno de acción.</p>",
      "<p>Aplicamos grandes efectos visuales (VFX) en todo el vídeo. Sincronizamos cortes rápidos con música electrónica muy intensa. Mostramos la verdadera adrenalina del modo Clash. Esta increíble pieza audiovisual fue clave para lograr una viralidad total.</p>",
