...
> = {
  "elixir-games": {
    ...
    esMediaHtml: [
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/ux-reimagined.webp" type="image/webp"><img src="/assets/cases/elixir-games/ux-reimagined.png" alt="ELIXIR GAMES — Interfaz de Usuario y Experiencia de Aplicación" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/kbw-event.webp" type="image/webp"><img src="/assets/cases/elixir-games/kbw-event.png" alt="ELIXIR GAMES — Evento Korean Blockchain Week y Networking" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/hoodie-design.webp" type="image/webp"><img src="/assets/cases/elixir-games/hoodie-design.png" alt="ELIXIR GAMES — Diseño de Merchandising y Ropa Oficial" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/elix-character.webp" type="image/webp"><img src="/assets/cases/elixir-games/elix-character.png" alt="ELIXIR GAMES — Diseño de Personajes y Activos 3D de $ELIX" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/token-burn.webp" type="image/webp"><img src="/assets/cases/elixir-games/token-burn.png" alt="ELIXIR GAMES — Campaña de Quemado de Tokens $ELIX" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/season-pass.webp" type="image/webp"><img src="/assets/cases/elixir-games/season-pass.png" alt="ELIXIR GAMES — Recompensas de Pase de Temporada y Clasificaciones" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/lottery.webp" type="image/webp"><img src="/assets/cases/elixir-games/lottery.png" alt="ELIXIR GAMES — Sorteo Comunitario y Evento de Cierre" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/launcher-banner.webp" type="image/webp"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Diseño de Roll-ups y Cartelería para Eventos Globales" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
    ...
    enMediaHtml: [
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/ux-reimagined.webp" type="image/webp"><img src="/assets/cases/elixir-games/ux-reimagined.png" alt="ELIXIR GAMES — User Interface and Application Experience" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/kbw-event.webp" type="image/webp"><img src="/assets/cases/elixir-games/kbw-event.png" alt="ELIXIR GAMES — Korean Blockchain Week Event & Networking" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/hoodie-design.webp" type="image/webp"><img src="/assets/cases/elixir-games/hoodie-design.png" alt="ELIXIR GAMES — Official Merchandise and Apparel Design" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/elix-character.webp" type="image/webp"><img src="/assets/cases/elixir-games/elix-character.png" alt="ELIXIR GAMES — $ELIX Character and 3D Assets" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/token-burn.webp" type="image/webp"><img src="/assets/cases/elixir-games/token-burn.png" alt="ELIXIR GAMES — $ELIX Token Burn Campaign and Supply Reduction" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/season-pass.webp" type="image/webp"><img src="/assets/cases/elixir-games/season-pass.png" alt="ELIXIR GAMES — Season Pass Rewards and Leaderboards" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/lottery.webp" type="image/webp"><img src="/assets/cases/elixir-games/lottery.png" alt="ELIXIR GAMES — Community Lottery and Closing Event" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
      '<figure class="wp-block-image"><picture><source srcset="/assets/cases/elixir-games/launcher-banner.webp" type="image/webp"><img src="/assets/cases/elixir-games/launcher-banner.jpg" alt="ELIXIR GAMES — Roll-up and Signage Design for Global Events" onerror="this.style.display=\'none\'" loading="lazy" /></picture></figure>',
